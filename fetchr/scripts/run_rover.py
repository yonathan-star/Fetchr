...
def _build_vision(args: argparse.Namespace, config: FetchrConfig):
    ...
    if args.camera == 'esp32cam':
        ...
        return LitVisionPipeline(detector=detector, light=FixedLedLight(gpio_pin=args.led_gpio))
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--led-gpio', type=int, default=21, help='GPIO pin for side LED illumination')
